...
//                正负
            ...
            if ((ch>='0'&&ch<='9')||ch=='.') {
                ...
                while(ch!=' '){
                    ...
                    while(ch!=' '&&(i>=j+1)){
                        ...
                        ch=postfix.charAt(++i);//在遇到一个数字时，将连续的数字字符解析为一个完整的数值，并将该数值压入栈中。
                    }
     ...
     * @param str2
     */
    public void numberProcessing(String str1 ,String str2){
